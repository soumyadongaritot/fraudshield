    ...
    <div class="auth-container">
      ...
      <div class="auth-tabs">
        <button class="auth-tab ${mode === "login" ? "active" : ""}"
          onclick="showAuthScreen('login')">Login</button>
        <button class="auth-tab ${mode === "signup" ? "active" : ""}"
          onclick="showAuthScreen('signup')">Sign Up</button>
      </div>
      ...
      <div class="auth-form">
        ...
        <button id="authBtn" class="auth-btn" onclick="handleAuth('${mode}')">
        ...
        <div class="auth-forgot">
          <span style="color:#6b7d99;font-size:11px">
            ...
            <a href="#" onclick="showAuthScreen('signup')" style="color:#00d4aa">Sign up</a>
          </span>
        </div>` : `
        <div class="auth-forgot">
          <span style="color:#6b7d99;font-size:11px">
            Already have an account?
            <a href="#" onclick="showAuthScreen('login')" style="color:#00d4aa">Login</a>
          </span>
        </div>`}
      </div>
